...
class model2:
    def __init__(self,inputShape, outputShape):
        x_skip = x
        f1, f2 = filters
        s =  [2,0,1,1,1,2,1,1,2,1,1,0]
        p =  [3,2,0,1,0,0,1,0,0,1,0,0]
        k =  [7,3,1,3,1,1,3,1,1,3,1,7]
        
        # first block
        x = Conv2D(f1, kernel_size=(k[0], k[0]), strides=(s[0], s[0]), padding='valid', kernel_regularizer=l2(0.001))(x)
